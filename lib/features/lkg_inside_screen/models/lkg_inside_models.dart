...
class LkgInsideModel {
  ...
  factory LkgInsideModel.fromJson(Map<String, dynamic> json,{String? title,int? sectionID,int? catID,String? videoUrl}) => LkgInsideModel(
    success: json["success"],
    data: List<LkgInsideModelList>.from(json["data"].map((x) => LkgInsideModelList.fromJson(x))),
...
class LkgInsideModelList {
  ...
  factory LkgInsideModelList.fromJson(Map<String, dynamic> json)  {
