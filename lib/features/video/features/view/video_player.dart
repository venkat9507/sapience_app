...
class VideoInsideScreenView extends StatefulWidget {
  ...
  const VideoInsideScreenView({Key? key,
    this.videoUrl,
    this.videoNumber,
  ...
  @override
  VideoInsideScreenViewState createState() => VideoInsideScreenViewState();
}

class VideoInsideScreenViewState extends State<VideoInsideScreenView> {
  ...
  void initState() {
    ...
    controller?.addListener(() {
      setState(() {
        print('isBufferingValue ${controller?.value.buffered}');

        defaultSeconds.value = controller!.value.position.inSeconds;
        staticSeconds.value = controller!.value.duration.inSeconds;
            ...
            children: <Widget>[
              ...
              GestureDetector(
                ...
                onTap: () {
                  setState(() {
                    ...
                    widget.videoBloc.add(VideoPauseButtonEvent());
              ...
              isOnTap == false
                ...
                child: InkWell(
                  onTap: () {
                    controller?.pause();
                    widget.videoBloc.add(VideoBackNavigateButtonEvent());
                  },
                  child: SizedBox(
                    // color: Colors.red,
                    width: 50 * fem,
          ...
          children: [
            InkWell(
              onTap: () {
                ...
                widget.videoBloc.add(ChangingTheVideoEvent(
                    videoNumber: widget.videoNumber,
